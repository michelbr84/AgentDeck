...
# Spec filenames are timestamp-prefixed and generated by the brainstorming skill
# (controlled charset), so ls's newline/alphanumeric caveats don't apply here.
